...
You can call me **Zecheng** ([/zəˈtʂʌŋ/], Mandarin pronunciation) / **Tong Zak Sing** (Cantonese pronunciatio) / **Eric Tong** (English) :)
...
- 👯 I was a research intern at Microsoft Research Asia (MSRA), focusing on **Multimodal Generation** and **Visual Representation** with LLMs (Visual ChatGPT, LayoutNUWA, and StrokeNUWA).
